...
export const Route = createFileRoute("/blog/")({
  ...
  head: ({ search }) => {
    ...
    const links: any[] = [{ rel: "canonical", href: "https://seoacademys.com/blog" }];
    
    if (page > 1) {
      links.push({ rel: "prev", href: `https://seoacademys.com/blog?page=${page - 1}` });
    }
    if (BLOG_POSTS.length > postsPerPage * page) {
      links.push({ rel: "next", href: `https://seoacademys.com/blog?page=${page + 1}` });
    }
