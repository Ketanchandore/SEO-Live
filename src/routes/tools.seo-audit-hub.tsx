  ...
  sections: [
    {
      ...
      steps: [
        { title: "Access Layer", body: "Check robots.txt, HTTP status, HTTPS, and redirects to ensure bots can reach the URL." },
        { title: "Index Layer", body: "Verify canonical tags, sitemap coverage, and meta robots directives to ensure the page can be indexed." },
        { title: "Content Layer", body: "Optimize the title, meta description, heading hierarchy, and internal links." },
        { title: "Experience Layer", body: "Audit the mobile viewport, page weight, and Core Web Vitals (LCP, CLS, INP)." }
      ],
    },
    {
      h2: "Use Case Comparison: Manual vs Automated Audits",
      body: [
        "While enterprise tools crawl the whole site overnight, manual single-page audits are critical for immediate deployment verification."
      ],
      table: {
        head: ["Feature", "SEOAcademys Hub (Manual)", "Paid Crawlers (Automated)"],
        rows: [
          ["Cost", "100% Free", "$100 - $1,000+ / mo"],
          ["Speed", "Instant real-time fetch", "Hours or days"],
          ["Scope", "Single URL deep dive", "Entire domain (10k+ URLs)"],
          ["Best For", "Pre-publish checks, fixing specific bugs", "Quarterly site-wide health reporting"]
        ]
      }
    },
    {
...
export const Route = createFileRoute("/tools/seo-audit-hub")({
  loader: () => getToolContent("seo-audit-hub"),
  head: () => hubHead(hub),
